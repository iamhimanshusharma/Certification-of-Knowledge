...
<div class="w3-top">
  ...
  <a class="w3-bar-item w3-hide-medium w3-hide-large w3-right" href="javascript:void(0);" onclick="toggleFunction()" title="Toggle Navigation Menu" style="margin-top:8px">
    ...
    {
      ?><a onclick="profile_portal()"><img src="images/admin/signup_profile.jpg" alt="login" width="50px" height="50px" class="w3-margin-top w3-circle w3-right w3-margin-right w3-border w3-hover-opacity"></a><?php
    }
    ?>
...
$query="SELECT * FROM `passed_students` WHERE `signup_id`='$login_photo'";
$run=mysqli_query($con,$query);
if(mysqli_num_rows($run)>0)
{
    $p_data=mysqli_fetch_assoc($run);
    ?>
    <div class="w3-card w3-margin" style="width:200px;height:200px">
<a href="pdf/pdf?course=<?php echo $p_data['course_passed'];?>"><img src="images/admin/certificate_logo.png" alt="" width="200px" height="140px">

<h4 style="padding-left:20px"><?php echo $p_data['course_passed'];?><img src="images/admin/verified.png" style="margin-left:70px" alt="" width="20px" height="20px"></h4>
</a>
</div>
    <?php
...
{
    ?><h3><?php echo "you don't have any certificate yet!";?></h3>
    <?php
}
