...
$organize_query="SELECT * FROM `question_files` WHERE `user_id`='$login_photo' AND `course`='$organize_exam_course_name'";
...
<hr>
    ...
    <input type="text" name="organize_course" value="<?php echo $organize_exam_course_name;?>" style="display:none">
    <input type="text" name="exam_count" value="<?php echo $newcount;?>" style="display:none">
