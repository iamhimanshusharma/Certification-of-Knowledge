...
return $randstr;
    ...
    $file_query="INSERT INTO `admin_question_files`(`file_name`,`user_id`, `course`,`exam_count`,`unique_exam_id`) VALUES ('$file', '$login_photo','$course','$exam_count','$unique_exam_id')";
...
else
{
  ?>
  <script>
  window.open('admin-choose-course','_self');
  </script>
  <?php
}
?>
