...
<hr>
    ...
    <a class="w3-border w3-white w3-hover-blue  w3-text-gray w3-button w3-round-large" href="profile">Profile</a>
      ...
      <a class="w3-bar-item w3-button w3-round w3-margin w3-text-grey w3-hide-small w3-border" href="profile" style="width:150px;margin-top:5px">Profile</a>
    ...
    <div class="w3-container">
      ...
      <a class="w3-bar-item w3-button w3-round w3-margin w3-text-grey " href="profile" style="width:150px;margin-top:5px">Profile</a>
...
<input type="submit" name="with_login_register">
</div>
...
<div class="w3-modal-content w3-round-large w3-card" style="width:60%;padding:20px;margin-top:85px">
<form class="w3-container" action="functions" method="post" enctype="multipart/form-data">
<input type="text" name="register_first_name" placeholder="First Name" class="w3-input">
<input type="text" name="register_last_name" placeholder="Last Name" class="w3-input">
<input type="email" name="register_email" placeholder="Email" class="w3-input">
<input type="password" name="register_password" placeholder="Password" class="w3-input">
<div class="w3-center">
<input type="submit" name="without_login_register" class="w3-btn w3-margin w3-green w3-text-white w3-card w3-round">
</div>
</div>
</div>
