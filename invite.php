...
<form action="invitation-status" method="post" onsubmit="return check()">
    <textarea name="emails" id="email" cols="30" rows="10"></textarea>
    <input type="text" value="<?php echo $_GET['id'];?>" style="display:none" name="exam_id">
...
if(email.length==0)
{
  alert("Enter at least two email");
  return false;
}
...
{
    alert("Should be separated by space");
  return false;
}
else
{
